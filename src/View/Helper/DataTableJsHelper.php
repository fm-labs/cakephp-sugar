...
class DataTableJsHelper extends DataTableHelper
{
    ...
    */
    ...
    public function initialize(array $config): void
    {
        ...
        //$this->Html->css('/sugar/sugarlte/plugins/datatables/jquery.dataTables.min.css', ['block' => true]);
        //$this->Html->css('/sugar/sugarlte/plugins/datatables/dataTables.bootstrap.css', ['block' => true]);
        //$this->Html->script('/sugar/sugarlte/plugins/datatables/jquery.dataTables.js', ['block' => true]);
        //$this->Html->script('/sugar/sugarlte/plugins/datatables/dataTables.bootstrap.js', ['block' => true]);

        //$this->Html->css('Sugar./js/datatables/dataTables.bootstrap.css', ['block' => true]);
        //$this->Html->script('Sugar.datatables/jquery.dataTables', ['block' => true]);
        //$this->Html->script('Sugar.datatables/dataTables.bootstrap', ['block' => true]);

        $this->Html->css('/sugar/vendor/DataTables/datatables.min.css', ['block' => true]);
        $this->Html->script('/sugar/vendor/DataTables/datatables.min.js', ['block' => true]);
        $this->Html->script('/sugar/js/sugar.datatables.js', ['block' => true]);
    }
