...
class ToastrHelper extends Helper
{
    ...
    {
        $this->Html->css('/sugar/libs/toastr/toastr.css', ['block' => true]);
        $this->Html->script('/sugar/libs/toastr/toastr.min.js', ['block' => true]);
    ...
    /**
     * Automatically render 'sugar' and default flash messages as toastr messages.
     *
